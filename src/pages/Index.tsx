...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        title="Центр строительных разрешений - Получите разрешение на строительство без штрафов и сносов"
        description="Центр строительных разрешений оформляет документы на строительство и ввод в эксплуатацию по всей России. С 2004 года помогаем получить разрешения без штрафов и сносов."
        keywords="разрешение на строительство, ввод в эксплуатацию, строительные документы, узаконивание, техническое заказчик, строительные разрешения"
        ogTitle="Центр строительных разрешений - Документы без штрафов и сносов"
